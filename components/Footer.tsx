            ...
            <div className="mt-6 p-4 bg-gray-800 rounded-xl">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 bg-gray-700 text-white text-xs px-3 py-2 rounded-lg outline-none placeholder-gray-500 focus:ring-1 focus:ring-indigo-500"
                />
                <button className="bg-indigo-600 hover:bg-indigo-700 text-white text-xs px-3 py-2 rounded-lg transition-colors font-medium">
                  Go
                </button>
              </div>
            </div>
